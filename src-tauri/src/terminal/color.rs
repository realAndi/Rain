...
pub fn indexed_to_rgb(index: u8) -> (u8, u8, u8) {
    match index {
        // Standard ANSI colors (using a Tokyo Night-ish palette)
        ...
        9 => (0xf7, 0x76, 0x8e),   // bright red
        10 => (0x9e, 0xce, 0x6a),  // bright green
        11 => (0xe0, 0xaf, 0x68),  // bright yellow
        12 => (0x7a, 0xa2, 0xf7),  // bright blue
        13 => (0xbb, 0x9a, 0xf7),  // bright magenta
        14 => (0x7d, 0xcf, 0xff),  // bright cyan
